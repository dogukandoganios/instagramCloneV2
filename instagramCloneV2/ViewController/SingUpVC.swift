...
class SingUpVC: UIViewController {
    ...
    func bodyApperance(){
        ...
        usernameTextField = textFieldClass(placeholderText: "Kullanıcı adı", borderWidth: 1, cornerRadius: height * 0.05 / 5, viewWidth: width, viewHeight: height, frameX: 0.5, frameY: 0.23, width: 0.7, height: 0.05)
        view.addSubview(usernameTextField)
        
        nextButton = buttonClass(titleString: "İleri", titleColor: .white, borderWidth: 1, cornerRadius: height * 0.05 / 5, fontSize: 0.04, borderColor: .blue, backgroundColor: .blue, viewWidth: width, viewHeight: height, frameX: 0.5, frameY: 0.3, width: 0.7, height: 0.05)
